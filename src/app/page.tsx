        ...
        <div className="container">
          <div className="hero-content">
            ...
            <p className="hero-sub">
              Elite volleyball camps built by an NCAA Head Coach and USA National Team Coach. We bring
        ...
        <div className="container">
          ...
          <div className="market-callout reveal">
            <p>
              ...
              <strong>Greg Walker Volleyball brings an NCAA Head Coach and USA National Team Coach directly to your gym</strong>{' '}
        ...
        <div className="container">
          <div className="about-grid">
            ...
            <div className="about-content">
              ...
              <p>
                Greg Walker is the Head Coach for Women's Volleyball at Smith College and a USA National Team
