          ...
          <div id="register" style={{ scrollMarginTop: 80 }}>
            ...
            <div style={{ textAlign: 'center', maxWidth: 560, margin: '0 auto', background: '#fff', border: '2px solid rgba(212,168,67,.3)', borderRadius: 12, padding: '40px 32px' }}>
              ...
              <div style={{ marginBottom: 20 }}>
                ...
                <div style={{ color: '#9A958E', fontSize: '.85rem', marginTop: 4 }}>per camper · Deerfield Academy, MA</div>
              </div>
              <a
                href="https://gregwalkervolley.regfox.com/2026-greg-walker-volleyball-camp-deerfield-ma"
                target="_blank"
